...
.Warps: db 2
	warp_def 11, 16, 1, SPROUT_TOWER_1F
	warp_def 11, 20, 2, SPROUT_TOWER_1F

.CoordEvents: db 0

.BGEvents: db 2
	signpost 12, 14, SIGNPOST_READ, Route31Sign
	signpost 5, 31, SIGNPOST_READ, DarkCaveSign

.ObjectEvents: db 7
	person_event SPRITE_FISHER, 15, 0, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31MailRecipientScript, -1
	person_event SPRITE_YOUNGSTER, 7, 1, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31YoungsterScript, -1
	person_event SPRITE_BUG_CATCHER, 4, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 3, TrainerBug_catcherWade1, -1
	person_event SPRITE_COOLTRAINER_M, 6, 29, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31CooltrainerMScript, -1
	person_event SPRITE_FRUIT_TREE, 5, 24, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31FruitTree, -1
	person_event SPRITE_POKE_BALL, 10, 24, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route31Potion, EVENT_ROUTE_31_POTION
	person_event SPRITE_POKE_BALL, 14, 18, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route31PokeBall, EVENT_ROUTE_31_POKE_BALL
