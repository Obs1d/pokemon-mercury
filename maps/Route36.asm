...
.Warps: db 4
	warp_def 14, 0, 3, ROUTE_31_VIOLET_GATE
	warp_def 15, 0, 4, ROUTE_31_VIOLET_GATE
	warp_def 2, 7, 1, ROUTE_36_RUINS_OF_ALPH_GATE
	warp_def 2, 8, 2, ROUTE_36_RUINS_OF_ALPH_GATE

.CoordEvents: db 2
	xy_trigger 1, 4, 4, 0, Route36SuicuneScript, 0, 0
	xy_trigger 1, 4, 6, 0, Route36SuicuneScript, 0, 0

.BGEvents: db 4
	signpost 3, 2, SIGNPOST_READ, Route36TrainerTips2
	signpost 3, 1, SIGNPOST_READ, RuinsOfAlphNorthSign
	signpost 19, 15, SIGNPOST_READ, Route36Sign
	signpost 4, 5, SIGNPOST_READ, Route36TrainerTips1

.ObjectEvents: db 9
	person_event SPRITE_YOUNGSTER, 9, 6, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerPsychicMark, -1
	person_event SPRITE_YOUNGSTER, 10, 17, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 5, TrainerSchoolboyAlan1, -1
	person_event SPRITE_WEIRD_TREE, 0, 6, SPRITEMOVEDATA_SUDOWOODO, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, SudowoodoScript, EVENT_ROUTE_36_SUDOWOODO
	person_event SPRITE_LASS, 14, 24, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 2, -1, -1, 0, PERSONTYPE_SCRIPT, 0, LassScript_0x1940e0, -1
	person_event SPRITE_FISHER, 8, 23, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route36RockSmashGuyScript, -1
	person_event SPRITE_FRUIT_TREE, 12, 8, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route36FruitTree, -1
	person_event SPRITE_YOUNGSTER, 20, 20, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, ArthurScript, EVENT_ROUTE_36_ARTHUR_OF_THURSDAY
	person_event SPRITE_LASS, 17, 7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, Route36FloriaScript, EVENT_FLORIA_AT_SUDOWOODO
	person_event SPRITE_SUICUNE, 0, 7, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_ON_ROUTE_36
