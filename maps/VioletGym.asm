...
.Warps: db 2
	warp_def 15, 4, 5, CORALTOWN
	warp_def 15, 5, 5, CORALTOWN
...
.ObjectEvents: db 4
	...
	person_event SPRITE_YOUNGSTER, 9, 7, SPRITEMOVEDATA_STANDING_LEFT, 0, 2, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 4, TrainerBird_keeperRod, -1
	person_event SPRITE_YOUNGSTER, 5, 2, SPRITEMOVEDATA_STANDING_RIGHT, 0, 2, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 4, TrainerBird_keeperAbe, -1
