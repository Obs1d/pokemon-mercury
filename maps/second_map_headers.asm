	...
	map_header_2 CherrygroveCity, CHERRYGROVE_CITY, 5, EAST | SOUTH
	...
	map_header_2 Route27, ROUTE_27, 53, EAST
	connection east, CORALTOWN, CoralTown, 6, 0, 17, ROUTE_27

	map_header_2 Route28, ROUTE_28, $2c, WEST
	connection west, SILVER_CAVE_OUTSIDE, SilverCaveOutside, -3, 6, 12, ROUTE_28

	map_header_2 Route29, ROUTE_29, 5, NORTH | EAST | SOUTH
	connection north, CHERRYGROVE_CITY, CherrygroveCity, 20, 0, 9, ROUTE_29
	connection south, CORALTOWN, CoralTown, 0, 0, 17, ROUTE_29
	connection east, NEW_BARK_TOWN, NewBarkTown, 1, 0, 9, ROUTE_29

	map_header_2 Route30, ROUTE_30, 53, SOUTH | WEST | EAST
	connection south, ROUTE_31, Route31, 9, 7, 13, ROUTE_30
	connection west, CHERRYGROVE_CITY, CherrygroveCity, 3, 0, 10, ROUTE_30
	connection east, ROUTE_36, Route36, -3, 0, 13, ROUTE_30

	map_header_2 Route31, ROUTE_31, 5, NORTH
	...
	map_header_2 Route36, ROUTE_36, 5, NORTH | WEST
	connection north, VIOLET_CITY, VioletCity, -3, 0, 17, ROUTE_36
	connection west, ROUTE_30, Route30, 3, 0, 12, ROUTE_36
	...
	map_header_2 CoralTown, CORALTOWN, 53, NORTH | WEST
	connection north, ROUTE_29, Route29, 0, 0, 20, CORALTOWN
	connection west, ROUTE_27, Route27, -1, 5, 18, CORALTOWN
