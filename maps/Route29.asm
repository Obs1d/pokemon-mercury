...
.BGEvents: db 2
	...
	signpost 0, 50, SIGNPOST_READ, Route29Sign2

.ObjectEvents: db 8
	person_event SPRITE_COOLTRAINER_M, 9, 52, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, CatchingTutorialDudeScript, -1
	person_event SPRITE_YOUNGSTER, 0, 40, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, Route29YoungsterScript, -1
	person_event SPRITE_COOLTRAINER_F, 10, 38, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route29TeacherScript, -1
	person_event SPRITE_FRUIT_TREE, 8, 39, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route29FruitTree, -1
