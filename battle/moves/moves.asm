...
ENDM
	...
	move PAY_DAY,      EFFECT_RECOIL_HIT,        120, FLYING,   100, 15,   0
	...
	move BIND,         EFFECT_HAIL,                0, ICE,      100, 10,   0
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,         100, FIGHTING,  95, 15,   0
	move ROLLING_KICK, EFFECT_NORMAL_HIT,         90, GRASS,    100, 15,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,         80, DRAGON,   100, 15,   0
	...
	move POISON_GAS,   EFFECT_POISON_HIT,        120, POISON,    80,  5,  30
	move BARRAGE,      EFFECT_LEECH_HIT,          50, FAIRY,    100, 25,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,      100, 10,   0
	move LOVELY_KISS,  EFFECT_SP_ATK_UP_2,         0, DARK,     100, 20,   0
	...
	move BONEMERANG,   EFFECT_NORMAL_HIT,         40, FAIRY,    100, 25,   0
	...
	move SKETCH,       EFFECT_SP_DEF_DOWN_HIT,    95, FAIRY,    100, 10,   0
	move TRIPLE_KICK,  EFFECT_FLINCH_HIT,         75, FLYING,   100, 15,  30
	...
	move SNORE,        EFFECT_FLINCH_HIT,         80, DARK,     100, 15,  20
	...
	move POWDER_SNOW,  EFFECT_PRIORITY_HIT,       40, ICE,      100, 30,   0
	...
	move PRESENT,      EFFECT_PRIORITY_HIT,       40, GHOST,    100, 30,   0
	...
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,         0, FIRE,      85, 15,   0
